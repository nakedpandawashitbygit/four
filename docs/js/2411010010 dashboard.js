                    ...
                    <form method="POST" action="/dashboard" id="edit-form-${data.id}">
                        ...
                        <div class="card-content">
                            ...
                            <p class="card-text card-short-url d-flex align-items-center">
								...
								<!-- QR Code button -->
								<button type="button" id="card-button-qr-${data.id}" class="btn btn-outline-primary btn-sm ms-2" onclick="showQrCodeModal('${siteUrl}/qrcodes/${data.id}.png')">
                            ...
                            <!-- Title -->
                            <p class="card-text">
                                <span id="title-text-${data.id}">${data.title ? data.title : 'Untitled'}</span>
