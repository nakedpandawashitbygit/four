                                            ...
                                            <div class="card-content">
												...
												*/
												...
												<p class="card-text card-short-url d-flex align-items-center">
													...
													<!-- Cancel button -->
													<button type="button" id="card-button-cancel-<?php echo $row['id']; ?>" class="btn btn-outline-secondary btn-sm ms-2" onclick="toggleEditAll(<?php echo $row['id']; ?>)" style="display: none;">❌</button>
													<!-- Delete button -->
