...
//$password = htmlspecialchars($_POST['password'] ? '******' : 'Set password');
//$password = (isset($_POST['link_password']) && $_POST['link_password'] !== '') ? '******' : 'Set password';
//$password = !empty($_POST['password']) ? '******' : 'Set password';
...
//var_dump($password); // This should output either '******' or 'Set password'
